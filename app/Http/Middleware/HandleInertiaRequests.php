...
class HandleInertiaRequests extends Middleware
{
    ...
    private function activePlan() {
        ...
        $lastDay = Carbon::parse($activePlan->updated_at)->addMonths($activePlan->subscriptionPlan->active_peroid_in_months);
        $activeDays = Carbon::parse($activePlan->updated_at)->diffInDays($lastDay);
        $remainingActiveDays = Carbon::now()->diffInDays($lastDay);
